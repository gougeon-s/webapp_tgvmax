...
package com.flyingpanda.tgvmax.webapp;
...
public abstract class WebAppActivity extends Activity {
    ...
    public void interceptRequest(WebView view, WebResourceRequest request){
        //nothing
    }
    ...
    protected class DefaultWebViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError er){
            Log.i("SSL Error",webView.getUrl());
            //handler.proceed(); // DEBUG : Ignore SSL certificate errors
        }
